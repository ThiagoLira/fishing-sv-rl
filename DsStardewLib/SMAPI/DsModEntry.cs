  ...
  public class DsModHelper<TConfig> where TConfig : class, new()
  {
    ...
    public void Init(IModHelper helper, IMonitor monitor)
    {
      ...
      Log.Silly("Loading event handlers");
            //helper.Events.Input.ButtonPressed += new EventHandler<EventArgsInput>(HandleKeyPress);
            helper.Events.Input.ButtonPressed += HandleKeyPress;
    ...
    /// <param name="e"></param>
    private void HandleKeyPress(object sender, ButtonPressedEventArgs e)
    {
